...
public class CardHandler : MonoBehaviour
{
    ...
    private int selectedUserCardCount;
    ...
    public void SetCards()
    {
        ...
        {
            monsterCard[i].Button.image.sprite = cardSO.sprites[deck[currIdx]];
            currIdx++;
        }
        // userCard 처리
        for (int i = 0; i < userCard.Length; i++)
        {
            userCard[i].Button.image.sprite = cardSO.sprites[deck[currIdx]];
            currIdx++;
        }
    }
